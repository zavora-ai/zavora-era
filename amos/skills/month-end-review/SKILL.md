...
allowed-tools: [get_dashboard, run_report, list_bills, list_invoices, list_payments, get_journal_entries, list_bank_accounts, list_reconciliations, list_tax_filings, list_fiscal_periods, close_period, reopen_period, browser_navigate, browser_snapshot, browser_click, showcase_step, plan_tasks, update_task]
metadata:
  author: Zavora AI
  category: period-end
  success-criteria:
