...
import { staffSetPassword } from '../../api/staffClient';
import { KeyRound } from 'lucide-react';

/** Accept-invite / password-reset: consumes a single-use token to set a password. */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500">Choose a password for your self-service account</p>
        </div>
