...
export const reportTypes: ReportMeta[] = [
  ...
  { key: 'CustomerPaymentHistory', name: 'Customer Payment History', desc: 'Every receipt from one customer, with method & unapplied amounts', controls: ['party', 'period'], party: 'customer', category: 'Receivables/Payables' },
