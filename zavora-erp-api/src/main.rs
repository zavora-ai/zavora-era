...
async fn main() -> anyhow::Result<()> {
    ...
    let protected = Router::new()
        ...
        .route("/api/v1/invoices/{id}/pay-link", get(routes::invoices::pay_link))
        ...
        .route("/api/v1/payroll/{run_id}/itax-csv", get(routes::payroll::itax_csv))
        ...
        .route("/api/v1/consolidation/groups", get(routes::consolidation::list_groups).post(routes::consolidation::create_group))
        .route("/api/v1/consolidation/groups/{id}/members", get(routes::consolidation::list_members).post(routes::consolidation::add_member))
        .route("/api/v1/consolidation/groups/{id}/members/{entity_id}", delete(routes::consolidation::remove_member))
        .route("/api/v1/consolidation/intercompany", get(routes::consolidation::list_intercompany).post(routes::consolidation::post_intercompany))
        .route("/api/v1/consolidation/group-trial-balance", post(routes::consolidation::group_trial_balance))
        ...
        .route("/api/v1/tax/cit/provision", post(routes::tax_filings::cit_provision))
