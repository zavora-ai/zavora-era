...
- [x] 1. P0 — Database Migration and Schema Foundation
  - [x] 1.1 Create migration 006 with all new tables and schema changes
...
- [x] 2. P0 — JWT Authentication Module
  - [x] 2.1 Implement JWT auth core in `zavora-erp-core`
  ...
  - [x] 2.5 Replace header-based `AuthContext` extractor with JWT middleware in `zavora-erp-api`
  ...
  - [x] 2.6 Implement login and token refresh routes
...
- [x] 3. P0 — Transaction Atomicity for Ledger-Coupled Flows
  - [x] 3.1 Refactor `create_and_post()` to accept `&mut sqlx::Transaction`
...
- [x] 5. P0 — Monetary Rounding Policy
  - [x] 5.1 Implement rounding utility functions in `zavora-erp-core`
  ...
  - [x] 5.2 Implement line-level VAT rounding and rounding adjustment
...
- [ ] 6. P0 — Automated Test Suite Foundation
  - [x] 6.1 Set up test infrastructure with `proptest` and integration test harness
